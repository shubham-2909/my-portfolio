...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className='font-bold'>Hello, I'm Shubham Gandhi.</span> I'm a{' '}
        <span className='font-bold'>full-stack web developer</span> who enjoys
        building <span className='italic'>sites & apps</span>.Currently I am
        focussing on <span className='underline'>Docker and Kubernetes</span>.
      </motion.h1>
